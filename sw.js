const CACHE='treino-feminino-prod-v5';
const ASSETS=['./index.html','./manifest.json','./config-tools.js','./history-tools.js','./workout-input-tools.js','./version-tools.js','./block-workout-tools.js','./female-enhancements.js','./lances-theme.js','./lances-tech-logo.png'];
